...
public class TripController {
    ...
    public ResponseEntity<ParticipantCreateResponse> inviteParticipant(@PathVariable UUID id, @RequestBody ParticipantRequestPayload payload){
        ...
        if(trip.isPresent()){
            ...
            ParticipantCreateResponse participantCreateResponse = this.participantsService.registerParticipantToEvent(payload.email(), rawTrip);
    ...
    public ResponseEntity<List<ParticipantData>> getAllParticipants(@PathVariable UUID id){
        List<ParticipantData> participantList = this.participantsService.getAllParticipantsFromEvent(id);
